...
#NOMBRES: Borda Aguirre Alan. Tango Torres Mia 
#El nivel maximo que la maquina soporta es de 7, se debe a que si aumentamos la cantidad de numeros en la lista 
#los nodos hijos se extenderian hasta el punto que la computadora tardaria mucho en resolverlo.
#se podria superar la cantida de numeros en la lista si hacemos una busqueda informada 
#LIFO: Quitando el 0 del pop, y dejando los parentesis vacios, la funcion agarraria y eliminaria el ultimo digito de la lista 
#expandiendo los nodos hijos.
