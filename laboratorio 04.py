#Lo primero que hice fue agregar un numero random del 0 al 1 al momento de crear los nodos
#  para despues agregar ese numero con un set_costo a cada hijo que va a tener nuestro rompecabezas
#  para luego convertir ese hijo en un nodo, implementamos la funcion de comparar para llamar al costo de nuestro nodos
#  por ultimo agregamos una lista de nodos_frontera fuera del for para que tome todos los 
# hijos despues de haberlos creado con su respectivo costos
# Esta lista ordenara los nodos de acuerdo a su costo.
#se tendria que agregar diferentes condicionantes a la hora de crear un hijo para que se elija el camino 
#mas efeciente y asi no se se sobrecargue el programa.
# lo maximo que logre hacer correr el programa fue a 7 fichas
